...
#ifndef _HYPERSPINXML_READER_HPP_
#define _HYPERSPINXML_READER_HPP_
...
/**
 * Parser lector para ficheros dat en el formato xml de HyperSpin
 */
class HyperspinXmlReader : public DatReader
{
public:
	/**
	 * Constructor de la clase
	 */
	HyperspinXmlReader(void);
...
#endif // _HYPERSPINXML_READER_HPP_
